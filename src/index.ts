...
export interface ExecutionContext {
    ...
    hadSoftError?: boolean // New flag to track if a recoverable error occurred
    softError?: SuperSelectorError // Stores the first soft error encountered
}
...
// export type LegacyParsedCommand = CssSelectorCommand | LegacyParsedFunctionCommand | LegacyParsedArrayPositionCommand; // Replaced by the main ParsedCommand
